...
class PostDeleteView(LoginRequiredMixin,View):
    def get(self,request,post_id):
        ...
        if post.user.id == request.user.id:
            ...
            messages.error(request,'you cant delete this post beacuse you are not the owner !','danger')
...
class PostUpdateView(LoginRequiredMixin,View):
    ...
    def dispatch(self,request,*args,**kwargs):
        ...
        if not request.user.id == post.user.id:
            messages.error(request,"you cant't update this form",'danger')
            return redirect('home:home')
...
class PostCreateView(LoginRequiredMixin,View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request,'you created form successfully','success')
